...
<section class="mt-4 mb-4">
    <section id="section1" class="container w-75 mt-2 mb-5" >
        <h4 class="display-4 font-weight-bold mt-4 mb-4 text-center">
            Phone Number Verification
        </h4>
        <div style="margin-top: 10px;" id="firebaseui-auth-container"></div>
...
<script src="src/js/phone.js"></script>
</body>
</html>